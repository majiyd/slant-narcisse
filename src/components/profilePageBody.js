    ...
    <div className="sidebar hide-mobile">
      <div className="sidebar-content">
        <div className="sidebar-section">
          <a className="sidebar-link selected" href="#">
            Recs (1)
          </a>
...
class MobileNavBar extends React.Component {
  ...
  toggleMobileNavbar() {
    this.setState({
      isMobileNavSelectVisible: !this.state.isMobileNavSelectVisible
    });
  }
  render() {
    return (
            ...
            <div className="event">
              <div className="event-avatar">
                <a className="avatar big" href="#">
                  <img
                    src="https://avatars.slant.co/identicons/50/9d224d3f-bc09-59d6-a6cc-de77c2b6d660"
              ...
              <div className="event-content">
                <a rel="nofollow" href="#">
                  Opeyemi added the <span>con </span>
                  <strong>Interpreted language</strong> to{" "}
                  <strong>Python</strong>.
                </a>
                <span className="event-time">a day ago</span>
