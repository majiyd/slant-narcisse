        ...
        <div className="tag-selector-tag-builder page-content">
          <div className="tag-selector-tag-builder-content">
            <div className="tag-selector-tag-builder-section">
              <div className="tag-selector-tag-builder-label">
                Subscribed Tags
              </div>
              <div className=" tag-selector-search">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search for a tag, e.g. Electronics, Gaming, Productivity"
                />
              </div>
              <div>
                <div className="tag-selector-tag-builder-copy">
                  Customize your Recommendation Feed to get started on Slant.
                  Find what you love and get help with what you need.
                </div>
              </div>
            </div>
            <div className="tag-selector-tag-builder-section">
      ...
      <div className="nav-header scrollable show-mobile">
        <div className="nav-header-content page-content">
          <div className="nav-header-list">
            <a className="nav-header-item selected" href="#">
              Recommendations
            </a>
            <a className=" nav-header-item" href="#">
              Questions
            </a>
            <a className=" nav-header-item" href="#">
              Top
